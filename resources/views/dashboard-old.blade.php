            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="text-center">
                        ...
                        <p class="text-3xl text-blue-600 font-bold">{{ $user->description_score }}</p>
                    </div>
                    <div class="text-center">
                ...
                <div class="p-6 bg-gray-50 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <label><input type="radio" name="exercise_type" value="Style" x-model="exerciseType" class="mr-2"> Style</label>
                            <label>
